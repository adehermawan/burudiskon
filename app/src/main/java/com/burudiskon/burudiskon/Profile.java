...
/**
 * Created by adehermawan on 9/10/15.
 */
...
public class Profile extends Fragment implements OnRequestSocialPersonCompleteListener {
    ...
    public static Profile newInstannce(int id) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        socialNetwork = Login.mSocialNetworkManager.getSocialNetwork(networkId);
    ...
    private View.OnClickListener friendsClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Friends friends = Friends.newInstannce(networkId);
    ...
    private void colorProfile(int networkId){
        ...
        switch (networkId) {
            ...
            case FacebookSocialNetwork.ID:
                ...
                image = R.drawable.facebook_user;
                break;
        }
