...
public class Friends extends Fragment implements OnRequestGetFriendsCompleteListener {

    private static final String NETWORK_ID = "NETWORK_ID";
    private ListView listView;

    public static Friends newInstannce(int id) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SocialNetwork socialNetwork = Login.mSocialNetworkManager.getSocialNetwork(networkId);
